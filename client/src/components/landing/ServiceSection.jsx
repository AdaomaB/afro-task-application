...
import {
  FaPalette, FaBullhorn, FaRobot, FaMagic, FaLaptopCode, FaVideo, FaPenNib,
} from "react-icons/fa";
import { FaToolbox } from "react-icons/fa6";
import { CiGlobe } from "react-icons/ci";

const iconMap = {
  TfiWrite, FaPalette, FaBullhorn, FaRobot, FaMagic,
  FaToolbox, FaLaptopCode, FaVideo, FaPenNib, CiGlobe,
};
  ...
  return (
    <section className="w-full px-2 md:px-1 py-6 md:py-10">
      <motion.h1
        ...
        className="text-3xl md:text-4xl lg:text-6xl font-bold flex justify-center items-center tracking-wider text-white mb-6 md:mb-10 text-center px-2"
      >
        Popular Services
      </motion.h1>
